...
#define TIMEHOLD		1000000ULL
#define TIMEBEACONNEW		3600000000ULL
#define	TIMEAUTHWAIT		200000ULL
#define	TIMEASSOCWAIT		200000ULL
#define	TIMEREASSOCWAIT		200000ULL
